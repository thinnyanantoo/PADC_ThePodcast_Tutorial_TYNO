...
class YourShowsRecyclerAdapter(private var delegate : ItemDelegate) : RecyclerView.Adapter<YourShowsRecyclerViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YourShowsRecyclerViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.rv_download_your_show_item,parent,false)
