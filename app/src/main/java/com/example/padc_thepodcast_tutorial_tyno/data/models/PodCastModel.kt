...
interface PodCastModel {
    ...
    fun getAllRandomPodCastFromFireBaseAndSaveToDatabase(
        onSuccess: (PodCastDetailVO) -> Unit,
        onError: (String) -> Unit
    )
    fun getAllRandom(onError: (String) -> Unit) : LiveData<PodCastDetailVO>
    ...
    fun getEpisodeDetailByIdFromApiAndSaveToDatabase(id: String, onSuccess: (PodCastDetailVO) -> Unit,onError: (String) -> Unit)
